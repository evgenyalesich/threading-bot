...
from app.strategies.three_screens_liquidity_strategy import ThreeScreensLiquidityStrategy
...
def normalize_strategy_name(value: str | None) -> str:
    ...
    aliases = {
        ...
        "three_screens_dom": "three_screens_liquidity",
        "three_screens_liquidity_dom": "three_screens_liquidity",
        "liquidity": "three_screens_liquidity",
    }
    return aliases.get(raw, raw or "three_screens_liquidity")
...
def build_strategy(
    ...
    if strategy_name == "three_screens_liquidity":
        return ThreeScreensLiquidityStrategy(
            indicator_service=indicator_service,
            trend_timeframe=trend_timeframe,
            h1_timeframe=h1_timeframe,
            filters=effective_filters,
